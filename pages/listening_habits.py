...
try:
    ...
    st.warning(f"⚠️ Since Manpreet's Spotify data can't be fetched — showing sample listening patterns instead! Add your own Spotify credentials to see your personal listening patterns!")
